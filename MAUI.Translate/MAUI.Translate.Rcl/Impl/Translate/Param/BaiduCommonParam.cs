...
{
    [JsonIgnore] private readonly Func<LanguageEnum, string?> _langConvert;

    public BaiduCommonParam(LanguageEnum fromLang, LanguageEnum toLang, string input, TranslateKey auth,
        Func<LanguageEnum, string?> langConvert)
    {
    ...
    [JsonIgnore] public TranslateKey Auth { get; }
    ...
    [JsonIgnore] public LanguageEnum FromLang { get; set; }

    public string? From => _langConvert.Invoke(FromLang);
    public string? To => _langConvert.Invoke(ToLang);

    [JsonIgnore] public LanguageEnum ToLang { get; set; }
